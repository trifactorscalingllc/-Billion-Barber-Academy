      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-[95%] md:w-[50%] brutalist-card bg-black overflow-hidden shadow-2xl"
          >
            <button 
              onClick={onClose}
            ...
            <div className="p-12 md:p-16">
                  ...
                  >
                    ...
                    <div className="grid gap-3">
                      {['Low Prices', 'No Consistent Leads', 'Trading Time for Money', 'Lack of Systems'].map((option) => (
                        <button key={option} className="w-full text-left p-6 brutalist-card border-white/10 hover:border-brand-gold bg-white/5 transition-all flex justify-between items-center group">
              ...
              <button 
                onClick={handleNext}
                className="w-full mt-12 bg-brand-gold text-black font-black uppercase italic py-6 brutalist-card flex items-center justify-center gap-2 hover:opacity-90 active:bg-white active:scale-[0.98] transition-all shadow-2xl btn-sheen"
              >
